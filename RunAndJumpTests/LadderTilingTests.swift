...
struct LadderTilingTests {
    ...
    func shortLadderIsSingleBottomTile() {
        ...
        #expect(tiles == [.init(heightInTiles: 1, textureName: TextureName.Ladder.bottom)])
        #expect(total == 1)
    }
    ...
    func twoWholeTilesHasNoMiddle() {
        ...
        #expect(tiles == [
            .init(heightInTiles: 1, textureName: TextureName.Ladder.bottom),
            .init(heightInTiles: 1, textureName: TextureName.Ladder.up),
        ])
        #expect(total == 2)
    }
    ...
    func wholeTilesFillMiddleWithFullTopTexture() {
        ...
        #expect(tiles == [
            .init(heightInTiles: 1, textureName: TextureName.Ladder.bottom),
            .init(heightInTiles: 1, textureName: TextureName.Ladder.middle),
            .init(heightInTiles: 1, textureName: TextureName.Ladder.middle),
            .init(heightInTiles: 1, textureName: TextureName.Ladder.middle),
            .init(heightInTiles: 1, textureName: TextureName.Ladder.up),
        ])
    ...
    func quarterRemainderMatchesExactly() {
        ...
        #expect(tiles.last == .init(heightInTiles: 0.25, textureName: TextureName.Ladder.up_25pct))
        #expect(total == 2.25)
    }
    ...
    func halfRemainderMatchesExactly() {
        ...
        #expect(tiles.last == .init(heightInTiles: 0.5, textureName: TextureName.Ladder.up_50pct))
        #expect(total == 3.5)
    }
    ...
    func threeQuarterRemainderMatchesExactly() {
        ...
        #expect(tiles.last == .init(heightInTiles: 0.75, textureName: TextureName.Ladder.up_75pct))
        #expect(total == 4.75)
    }
    ...
    func remainderAboveThreeQuartersRoundsUpToWholeTile() {
        ...
        #expect(tiles.last == .init(heightInTiles: 1, textureName: TextureName.Ladder.up))
        #expect(total == 3)
    }
