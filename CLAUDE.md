...
- **Когда сохраняем**: подъём флага, гибель, конец уровня — то есть в моменты игровых событий, а **не** по сигналам жизненного цикла. Свёрнутое приложение iOS выгружает без предупреждения, и надёжного «сохранись перед смертью» не существует. Прохождение всей игры сохранение стирает.
