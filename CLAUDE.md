...
- **`Resources/Styles/`** — сами каталоги (`GrasslandCatalog`, `CaveCatalog`) и реестр `StyleCatalogs`: единственное место, где `LevelStyleID` превращается в каталог.
